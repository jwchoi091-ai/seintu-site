...
/** 자주 묻는 질문 (문의 페이지) — 사장님이 이 배열만 고치면 됨 */
...
export const faqs: Faq[] = [
  {
    q: '나무는 어떻게 배송되나요?',
    a: '소형 묘목·소형목은 택배로, 대형목은 화물 또는 직접 운송(별도 협의)으로 배송합니다. 규격·수량·지역에 따라 배송비가 달라지므로 견적 문의 시 함께 안내해 드립니다.',
  },
  {
    q: '규격의 R은 무슨 뜻인가요?',
    a: 'R은 근원경(나무 밑둥의 지름)을 뜻합니다. 예를 들어 R8은 밑둥 지름이 약 8cm라는 의미로, 숫자가 클수록 더 크고 성숙한 나무입니다. 같은 년생이라도 자란 정도에 따라 R이 다를 수 있어, 실제 측정값으로 안내합니다.',
  },
  {
    q: '심는 것(식재 시공)도 해주시나요?',
    a: '대형목은 굴취·운반·식재까지 협의해 진행할 수 있습니다. 현장 조건에 따라 비용이 달라지므로 견적 문의에서 "식재 시공 필요"를 선택해 상담해 주세요.',
  },
  {
    q: '농장에 방문해서 직접 보고 살 수 있나요?',
    a: '사전 예약 후 농장 방문이 가능합니다. 수사해당화가 만개하는 시기의 개방일은 [농장 일정]에서 확인하실 수 있습니다.',
  },
  {
    q: '결제는 어디서 하나요?',
    a: '소형·정찰가 상품은 네이버 스마트스토어에서 결제하시고, 대형목·대량 분양은 견적 상담 후 협의해 진행합니다.',
  },
  {
    q: '교환·반품이 되나요?',
    a: '살아있는 나무의 특성상 단순 변심에 의한 반품은 어렵습니다. 다만 수령 시 명백한 하자가 있는 경우 사진과 함께 빠르게 연락 주시면 성실히 조치해 드립니다.',
  },
  {
    q: '심은 뒤 관리가 어렵지 않나요?',
    a: '식재 방법과 물 주기·지주대 설치 등 기본 관리법을 함께 안내해 드립니다. 농장 식재 교육도 정기적으로 열고 있으니 [농장 일정]을 참고해 주세요.',
  },
]
